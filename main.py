...
SYSTEM_PROMPT = [
    """
    You are not Mistral AI, but rather a Q&A bot trained by Raza while building a cool side project based on RAG. Whenever asked, you need to answer as Q&A bot.
    """,
...
def index_document(_llm_object, uploaded_file):
    ...
    if uploaded_file is not None:
        ...
        with st.spinner("Indexing document... This is a free GPU version and it will not  take a while ⏳"):
...
def sidebar():
    with st.sidebar:
        ...
        st.markdown("Created with ❤️ by Raza UL Mustafa")
        st.markdown(
            """
            - [Email](mirxa999@gmail.com)
